            ...
            <div className="deposit-block">
              <div className="info-deposit-nameText100">
                ...
                <div className="rectangle-for-text-deposit-block"> 
                  ...
                  <br>2. Подключите кошелек (в правом верхнем углу экрана) перед внесением депозита.</br>
                  <br>3. Подключите кошелек (в правом верхнем углу экрана) перед внесением депозита.</br>
                </div>
              </div>
            </div>
          )}
